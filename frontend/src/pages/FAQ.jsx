...
const FAQ_DATA = {
  'General': [
    ...
    { q: "How long before I see results?", a: "PPC: days. SEO: 2–4 months. AI automation: immediate. Social media: 2–3 months for meaningful growth." },
  ...
  'SEO': [
    { q: "How long does SEO take?", a: "Typically 2–4 months for meaningful movement on competitive terms. Less competitive niches can move faster." },
  ...
  'PPC & Ads': [
    ...
    { q: "What is the minimum PPC budget?", a: "Budgets vary based on your goals and competition. Most businesses start from ₹15,000/month ($200+), but we recommend a customised budget for better performance and ROI." },
    { q: "Do you manage Facebook/Meta ads?", a: "Yes, we manage Google Ads, Meta Ads (Facebook + Instagram), and LinkedIn Ads." },
    { q: "How do you track conversions?", a: "We set up Google Tag Manager and platform-native pixels to track every meaningful action from click to purchase." },
    { q: "How long before my PPC campaign is optimised?", a: "The first 2–3 weeks are a learning phase. Meaningful optimisation typically happens in months 2–3." }
  ],
  'AI & Automation': [
    ...
    { q: "What tools do you use for automation?", a: "We primarily work with n8n, Zapier and custom-built workflows depending on complexity." },
  ...
  'Working With Us': [
    ...
    { q: "How will I be kept informed?", a: "Regular reports (weekly or monthly depending on your plan), shared dashboards, and direct email access to your account manager." },
